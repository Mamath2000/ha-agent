...
try {
    Import-Module -Name $PsmqttModulePath -ErrorAction Stop
}
catch {
    "Erreur: Impossible de charger le module PSMQTT depuis '$PsmqttModulePath'. $_" | Out-File -FilePath (Join-Path $PSScriptRoot "logs" "error.log") -Append
    exit 1
}
